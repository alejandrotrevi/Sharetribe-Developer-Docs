...
summary: "This tutorial is the place to start your journey building custom integrations using the Sharetribe Integration API."
---

- [Table of Contents](#table-of-contents)
  - [Install development tooling](#install-development-tooling)
  - [Clone the examples Git repository](#clone-the-examples-git-repository)
  - [Install the dependencies](#install-the-dependencies)
  - [Create Integration API application in Sharetribe Console](#create-integration-api-application-in-sharetribe-console)
  - [Configuration](#configuration)
  - [Run an example report](#run-an-example-report)
...
## Overview
The Sharetribe Integration API is an application programming interface that provides full access to the marketplace's data. It can be used to build applications that integrate different own or 3rd party systems with the Sharetribe marketplace. For an overview of the different APIs that Sharetribe provides, read [this article](https://www.sharetribe.com/docs/concepts/marketplace-api-integration-api/).

In this tutorial, you will download, set up and run an [example Integration API command line script](https://github.com/sharetribe/integration-api-examples) that will report some data about your Sharetribe marketplace.
...
The example scripts use the Sharetribe Integration SDK for JavaScript. In order for the SDK to authenticate to the Integration API, it requires two values: a client ID and a client secret. You can obtain both by creating a new [Integration API application](https://www.sharetribe.com/docs/concepts/applications/) in Sharetribe Console.

Log in to your marketplace in [Sharetribe Console](https://console.sharetribe.com/) and navigate to [Build > Applications](https://console.sharetribe.com/advanced/applications).

1. Click the `Add new` link.
2. Fill in an application name (for instance "My example integration") and choose `Integration API` as the API.
...
You can get a summary report for your marketplace listings, users and transactions by running the following example:
```bash
...
## Next steps
- Study the examples [source code](https://github.com/sharetribe/integration-api-examples) to get a better understanding on how to use the Integration SDK.
- Read the [Integration API reference documentation](https://www.sharetribe.com/api-reference/).
