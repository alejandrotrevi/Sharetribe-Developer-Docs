...
summary: "By default, the template uses Mapbox for showing interactive maps. This guide will help you create a Mapbox account and assign the access token to an environment variable."
---

- [Table of Contents](#table-of-contents)
  - [Generate a Mapbox access token](#generate-a-mapbox-access-token)
  - [Update the API key in Console](#update-the-api-key-in-console)
  - [Assign the access token to an environment variable](#assign-the-access-token-to-an-environment-variable)
...
Read more in our article on [how to set up Mapbox or Google Maps for location services](https://www.sharetribe.com/help/en/articles/8676185-how-to-set-up-mapbox-or-google-maps-for-location-services).
...
If you are using a version of the template older than [v3.4.0](https://github.com/sharetribe/web-template/releases/tag/v3.4.0), you need to assign the Mapbox API key to an environment variable.
