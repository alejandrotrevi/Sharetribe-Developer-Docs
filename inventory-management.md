...
summary: "Inventory or stock management is a key feature of many product marketplaces. Here’s how the Sharetribe stock management works."
---

- [Overview](#overview)
- [How do you determine the initial available stock or increase the available stock of a listing?](#how-do-you-determine-the-initial-available-stock-or-increase-the-available-stock-of-a-listing)
- [How do you remove or decrease the available stock of a listing?](#how-do-you-remove-or-decrease-the-available-stock-of-a-listing)
- [Can listings be closed automatically if there is no stock left?](#can-listings-be-closed-automatically-if-there-is-no-stock-left)
- [How to manage the number of seats or spaces for an event or a class?](#how-to-manage-the-number-of-seats-or-spaces-for-an-event-or-a-class)
...
If the transaction completes, the purchased units are removed from the inventory permanently. If the transaction is canceled, the units are released back to the inventory and other users will be able to purchase them. Find out more about [transaction process actions related to stock reservations](/docs/references/transaction-process-actions/#stock-reservations).
...
If you are looking to manage the number of spaces in an event, you should take a look at the seats feature. With seats, you can manage the number of available spaces in a given event at a given time. Seats are tied to [booking availability management](/docs/concepts/manage-seats/).
