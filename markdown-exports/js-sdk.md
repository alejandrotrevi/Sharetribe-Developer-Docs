...
summary: "Information on our SDKs and where to find our SDK documentation."
---

- [Documentation](#documentation)
- [Features](#features)
- [Sharetribe SDK for JavaScript](#sharetribe-sdk-for-javascript)
- [Sharetribe Integration SDK for JavaScript](#sharetribe-integration-sdk-for-javascript)
...
The Marketplace API is meant to handle all the interactions that the end users of your marketplace participate in, e.g., signing up, managing listings, and transactions. You should be using the Marketplace API when building your marketplace UI, such as a web client or a mobile app.
...
[https://sharetribe.github.io/flex-sdk-js/](https://sharetribe.github.io/flex-sdk-js/)
...
You can access all the JS SDK documentation at:
[https://sharetribe.github.io/flex-integration-sdk-js/](https://sharetribe.github.io/flex-integration-sdk-js/)
