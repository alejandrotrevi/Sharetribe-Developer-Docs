...
summary: "This guide describes how the default sitemap works in the Sharetribe Web Template, and how to customise it."
---

- [Table of Contents](#table-of-contents)
  - [Template sitemap structure](#template-sitemap-structure)
  - [robots.txt](#robotstxt)
  - [sitemap-index.xml](#sitemap-indexxml)
  - [sitemap-default.xml](#sitemap-defaultxml)
  - [sitemap-recent-listings.xml](#sitemap-recent-listingsxml)
  - [sitemap-recent-pages.xml](#sitemap-recent-pagesxml)
  - [Sitemap caching](#sitemap-caching)
  - [Adding your sitemap to Google](#adding-your-sitemap-to-google)
...
You can read more about the template sitemap and other resources in the [Resources README](https://github.com/sharetribe/web-template/blob/main/server/resources/README.md).
...
The index and the sub-sitemaps are generated in [server/resources/sitemap.js](https://github.com/sharetribe/web-template/blob/main/server/resources/sitemap.js).

### sitemap-default.xml
The [your-domain]/**sitemap-default.xml** file includes your marketplace's public built-in pages. It also includes the landing page, the terms of service page, and the privacy policy page – these pages have specified paths in the default template, even though their content is fetched from assets.

If you add public custom paths to your template, remember to [add them in this sitemap](https://github.com/sharetribe/web-template/blob/main/server/resources/sitemap.js#L45) as well. You can also add sitemap entries for some of your key searches, e.g.
...
The default logic filters out the pages that have custom paths: landing page, terms of service, and privacy policy. If you add public permanent paths for asset-based pages to your template and your *sitemap-default.xml* file, be sure to filter them out of the SDK result set in [server/resources/sitemap.js#L284](https://github.com/sharetribe/web-template/blob/main/server/resources/sitemap.js#L284).

## Sitemap caching
The template caches sitemap data [for one day by default](https://github.com/sharetribe/web-template/blob/main/server/resources/sitemap.js#L55). In addition, the sitemap API endpoints cache results for one day. This means that when using the template, the combined cache effect can be up to two days.
