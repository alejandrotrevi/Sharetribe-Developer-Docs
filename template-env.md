...
- [List of Available Environment Variables](#list-of-available-environment-variables)
...
- **`REACT_APP_MAPBOX_ACCESS_TOKEN`**  
  See the [How to set up Mapbox](https://www.sharetribe.com/docs/template/how-to-set-up-mapbox-for-template/) guide for more information.

- **`REACT_APP_GOOGLE_MAPS_API_KEY`**  
  See the [How to use Google Maps](https://www.sharetribe.com/docs/template/how-to-use-google-maps-in-template/) guide for more information.

- **`REACT_APP_SHARETRIBE_SDK_CLIENT_ID`**  
  Your application's client ID. You can get this from [Sharetribe Console](https://console.sharetribe.com/advanced/applications).

- **`SHARETRIBE_SDK_CLIENT_SECRET`**  
  Your application's client secret. It's related to client ID and used for privileged transitions from server side. You can get this from [Sharetribe Console](https://console.sharetribe.com/advanced/applications).
...
- **`REACT_APP_SENTRY_DSN`**  
  See the [How to set up Sentry to log errors](https://www.sharetribe.com/docs/template/how-to-set-up-sentry/) guide for more information.

- **`REACT_APP_CSP`**  
  See the [How to set up Content Security Policy (CSP)](https://www.sharetribe.com/docs/template/how-to-set-up-csp-for-template/) guide for more information.
...
- **`REACT_APP_GOOGLE_ANALYTICS_ID`**  
  See the [How to set up Analytics](https://www.sharetribe.com/docs/template/how-to-set-up-analytics-for-template/) guide for more information.

- **`REACT_APP_PLAUSIBLE_DOMAINS`**  
  Used to configure Plausible Analytics. Read more in [how to set up analytics](https://www.sharetribe.com/docs/template/how-to-set-up-analytics-for-template/).
...
> **Warning**: Only use the `REACT_APP` prefix with environment variables that you want to reveal to the public internet. It is important to **never** publicly reveal the client secret of the Marketplace or Integration API – in other words, DO NOT prefix those variables with `REACT_APP`!
