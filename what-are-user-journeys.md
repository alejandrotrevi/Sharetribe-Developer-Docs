...
summary: "A user journey map illustrates the step by step process that users take to complete a task. You should answer, 'How do users use the marketplace?'"
---

- [Table of Contents](#table-of-contents)
  - [What are user journeys?](#what-are-user-journeys)
  - [The Template user journeys](#the-template-user-journeys)
